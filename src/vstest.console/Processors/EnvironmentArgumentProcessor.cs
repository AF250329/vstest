...
namespace Microsoft.VisualStudio.TestPlatform.CommandLine.Processors
{
    ...
    internal class EnvironmentArgumentProcessor : IArgumentProcessor
    {
        ...
        internal class ArgumentExecutor : IArgumentExecutor
        {
            ...
            public ArgumentProcessorResult Execute(IObjectWriter objectWriter = null, ITestPlatformEventSource testPlatformEventSource = null) => ArgumentProcessorResult.Success;
        }
    }
}
